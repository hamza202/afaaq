                ...
                <div class="col-md-7">
                    <form>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" required placeholder="الأسم">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name"> بريد الكتروني <span class="red-color">*</span></label>
                                    <input type="text" class="form-control" id="name" required placeholder="الأسم">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="subject" required placeholder="الموضوع">
                        </div>
                        <div class="form-group">
                            <label for="news">الخبر <span class="red-color">*</span></label>
                            <textarea class="form-control" id="news" rows="3" required placeholder="الخبر"></textarea>
                        </div>
